...
import { CarService } from './user/user.service';
...
@Component({
  ...
  `,
  standalone: true,
  imports: [CommentsComponent, UserComponent, RouterOutlet, RouterLink, LowerCasePipe, DecimalPipe, DatePipe, CurrencyPipe ],
})
